...
public extension Api {
    func getTokenAccountsByOwnerExtended(pubkey: String, mint: String? = nil, programId: String? = nil, configs: RequestConfiguration? = nil, onComplete: @escaping (Result<[SolanaTokenAccountsByOwnerValue], Error>) -> Void) {
        var parameterMap = [String: String]()
        if let mint = mint {
            parameterMap["mint"] = mint
        } else if let programId =  programId {
