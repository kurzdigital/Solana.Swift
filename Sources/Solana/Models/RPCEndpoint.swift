...
public struct RPCEndpoint: Hashable, Codable {
    ...
    public static let mainnetGenesysGo = RPCEndpoint(url: URL(string: "https://ssc-dao.genesysgo.net")!, urlWebSocket: URL(string: "wss://ssc-dao.genesysgo.net")!, network: .mainnetBeta)
